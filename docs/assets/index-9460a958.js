...
const J_ = 'modulepreload',
  Q_ = function (i) {
    return '/geography-research-project/' + i;
  },
  kc = {},
  ep = function (e, t, n) {
...
const ZE = '/logo.png',
  ...
  qE = {
    ...
    mounted() {
      (pt = new Bd({ target: 'main-map', view: new At({ center: [0, 0], zoom: 2 }) })),
...
const JE = { id: 'olMap' },
  QE = { ref: 'main-map', class: 'mapContainer', id: 'main-map' };
...
const sf = Hl(qE, [['render', eC]]),
  ...
  rf = (i) => (mg('data-v-9919db43'), (i = i()), _g(), i),
...
const rC = Hl(sC, [['__scopeId', 'data-v-9919db43']]),
